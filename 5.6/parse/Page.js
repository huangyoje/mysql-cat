...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['kaitai-struct/KaitaiStream', './UndoLogPageBody', './TrxSysPageBody', './InodePageBody', './IbufBitmapPageBody', './SysPageBody', './FspHdrPageBody', './IndexPageBody'], factory);
  } else if (typeof module === 'object' && module.exports) {
    module.exports = factory(require('kaitai-struct/KaitaiStream'), require('./UndoLogPageBody'), require('./TrxSysPageBody'), require('./InodePageBody'), require('./IbufBitmapPageBody'), require('./SysPageBody'), require('./FspHdrPageBody'), require('./IndexPageBody'));
  } else {
    root.Page = factory(root.KaitaiStream, root.UndoLogPageBody, root.TrxSysPageBody, root.InodePageBody, root.IbufBitmapPageBody, root.SysPageBody, root.FspHdrPageBody, root.IndexPageBody);
  }
}(this, function (KaitaiStream, UndoLogPageBody, TrxSysPageBody, InodePageBody, IbufBitmapPageBody, SysPageBody, FspHdrPageBody, IndexPageBody) {
var Page = (function() {
  ...
  Page.prototype._read = function() {
    ...
    case Page.PageType.SYS:
      this.body = new SysPageBody(this._io, this, null);
      break;
    case Page.PageType.UNDO_LOG:
      this.body = new UndoLogPageBody(this._io, this, null);
      break;
    ...
    case Page.PageType.TRX_SYS:
      this.body = new TrxSysPageBody(this._io, this, null);
      break;
    case Page.PageType.INDEX:
      this.body = new IndexPageBody(this._io, this, null);
      break;
    ...
    case Page.PageType.IBUF_BITMAP:
      this.body = new IbufBitmapPageBody(this._io, this, null);
      break;
    }
  ...
  var PageHeader = Page.PageHeader = (function() {
    ...
    PageHeader.prototype._read = function() {
      ...
      this.pageNumber = this._io.readU4be();
